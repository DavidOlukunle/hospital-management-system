...
<form class="space-y-4 md:space-y-6" action="{{url('Admin/edit_doctor',$docs->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div>
        ...
        <select name="speciality" class="bg-gray-5" >
            <option value="{{$docs->speciality}}">{{$docs->speciality}}</option>
